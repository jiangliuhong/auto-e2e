...
4. Create one `.auto-e2e/specs/<name>.spec.json` file per independent scenario. Make every acceptance criterion atomic and observable. Declare local upload templates in `inputs` and exact page results in `outputs`.
